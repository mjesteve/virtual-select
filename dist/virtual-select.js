...
function _defineProperty(e, r, t) { return (r = virtual_select_Ext_toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function virtual_select_Ext_typeof(o) { "@babel/helpers - typeof"; return virtual_select_Ext_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, virtual_select_Ext_typeof(o); }
function virtual_select_Ext_slicedToArray(r, e) { return virtual_select_Ext_arrayWithHoles(r) || virtual_select_Ext_iterableToArrayLimit(r, e) || virtual_select_Ext_unsupportedIterableToArray(r, e) || virtual_select_Ext_nonIterableRest(); }
function virtual_select_Ext_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function virtual_select_Ext_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function virtual_select_Ext_arrayWithHoles(r) { if (Array.isArray(r)) return r; }
function virtual_select_Ext_toConsumableArray(r) { return virtual_select_Ext_arrayWithoutHoles(r) || virtual_select_Ext_iterableToArray(r) || virtual_select_Ext_unsupportedIterableToArray(r) || virtual_select_Ext_nonIterableSpread(); }
function virtual_select_Ext_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function virtual_select_Ext_unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return virtual_select_Ext_arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? virtual_select_Ext_arrayLikeToArray(r, a) : void 0; } }
function virtual_select_Ext_iterableToArray(r) { if ("undefined" != typeof Symbol && null != r[Symbol.iterator] || null != r["@@iterator"]) return Array.from(r); }
function virtual_select_Ext_arrayWithoutHoles(r) { if (Array.isArray(r)) return virtual_select_Ext_arrayLikeToArray(r); }
function virtual_select_Ext_arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
function virtual_select_Ext_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function virtual_select_Ext_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, virtual_select_Ext_toPropertyKey(o.key), o); } }
function virtual_select_Ext_createClass(e, r, t) { return r && virtual_select_Ext_defineProperties(e.prototype, r), t && virtual_select_Ext_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function virtual_select_Ext_toPropertyKey(t) { var i = virtual_select_Ext_toPrimitive(t, "string"); return "symbol" == virtual_select_Ext_typeof(i) ? i : i + ""; }
function virtual_select_Ext_toPrimitive(t, r) { if ("object" != virtual_select_Ext_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != virtual_select_Ext_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
var VirtualSelect = /*#__PURE__*/function () {
  ...
  return virtual_select_Ext_createClass(VirtualSelect, [{
    key: "render",
    ...
    value: function setValue(value) {
      ...
      if (!isValidValue) {
        ...
        this.selectedValues = virtual_select_Ext_toConsumableArray(normalizedValue);
      } else {
      ...
      if (showAllText && this.hideValueTooltipOnSelectAll) {
        ...
        selectedOptions.some(function (d) {
          ...
          if (showValueAsTags) {
            ...
            var valueTooltipForTags = Utils.willTextOverflow($valueText.parentElement, label) ? _this0.getTooltipAttrText(label, false, true) : '';

            // replace is nedded to remove html tags from aria-label (ex: when there is an icon in the label)
            var ariaLabelClearBtnTxt = '';
            if (_this0.ariaLabelTagClearButtonText) {
              var stripHtmlLabel = label.replace(/<[^>]+>/ig, '').trim();
              ariaLabelClearBtnTxt = "aria-label=\"".concat(stripHtmlLabel, ", ").concat(_this0.ariaLabelTagClearButtonText, "\"");
            }
